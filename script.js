...
var friendsDiv = document.querySelector("#friends-div");
...
var lis = document.querySelectorAll(".liId");
        newUl = document.createElement("ul");
        friendsDiv.removeChild(ul);
        friendsDiv.appendChild(newUl);
   for(var i = 0; i < friends.length; i++){
        newLi = document.createElement("li");
        newUl.appendChild(newLi);
        friends.appendChild
        friends = sentenceSplit.slice(0);
        console.log(friends[i]);
        newLi.innerText = friends[i];
    }
});